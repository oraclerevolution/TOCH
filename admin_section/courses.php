  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Services demandés</li>
      </ol>
		<div class="box_general">
			<div class="header_box">
				<h2 class="d-inline-block">Listes des services en attente</h2>
			</div>
			<div class="list_general">
				<ul>
					<li>
						<figure><img src="img/course_1.jpg" alt=""></figure>
						<h4>Course title <i class="pending">En attente</i></h4>
						<ul class="course_list">
							<li><strong>Date de demande</strong> 11 November 2017</li>
							<li><strong>Nom et prenoms</strong> 11 April 2018</li>
						...
						<ul class="buttons">
							<li><a href="#0" class="btn_1 gray approve"><i class="fa fa-fw fa-check-circle-o"></i> Approuver </a></li>
							<li><a href="#0" class="btn_1 gray delete"><i class="fa fa-fw fa-times-circle-o"></i> Decliner </a></li>
						</ul>
					</li>
				</ul>
			</div>
